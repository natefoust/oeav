...
BEGIN_MESSAGE_MAP(OperationsTemplatesDlg, CDialogX)
	ON_WM_ERASEBKGND()
...
OperationsTemplatesDlg::OperationsTemplatesDlg(CWnd* pParent /*=nullptr*/)
	: CDialogX(IDD_THO, pParent),
	_chooseMode(false),
	_updateData(false)
{
...
void OperationsTemplatesDlg::DoDataExchange(CDataExchange* pDX)
{
...
BOOL OperationsTemplatesDlg::OnInitDialog()
{
...
void OperationsTemplatesDlg::initControls()
{
...
void OperationsTemplatesDlg::buildLayout()
{
	UpdateLayout();
}

void OperationsTemplatesDlg::onAddRequested()
{
	updateContext();
...
void OperationsTemplatesDlg::onDeleteRequested()
{
	updateContext();
...
void OperationsTemplatesDlg::onExitRequested()
{
	updateContext();
...
void OperationsTemplatesDlg::fillTable()
{
	_operations = InstanceFactory<service::ICardfilesService>::getInstance()->getTypicalOperations();
...
void OperationsTemplatesDlg::fillComboboxes()
{
...
void OperationsTemplatesDlg::changeDisplayedItem(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void OperationsTemplatesDlg::onChooseRequested()
{
	updateContext();
...
void OperationsTemplatesDlg::setSelection(int itemNum)
{
...
void OperationsTemplatesDlg::updateContext()
{
	if (_operations->empty())
	{
...
void OperationsTemplatesDlg::onNextRequested()
{
	updateContext();
...
void OperationsTemplatesDlg::onPrevRequested()
{
	updateContext();
