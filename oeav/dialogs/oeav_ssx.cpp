...
BEGIN_MESSAGE_MAP(oeav_ssx, CDialogX)
	ON_WM_ERASEBKGND()
...
oeav_ssx::oeav_ssx(CWnd* pParent /*=nullptr*/)
	: CDialogX(OEAV_SSX, pParent),
	_chooseMode(false)
{

}

void oeav_ssx::DoDataExchange(CDataExchange* pDX)
{
...
void oeav_ssx::buildLayout()
{
	UpdateLayout();
}

void oeav_ssx::onAddRequested()
{
	updateContext();
...
void oeav_ssx::onDeleteRequested()
{
	updateContext();
...
void oeav_ssx::changeDisplayedItem(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void oeav_ssx::onChooseRequested()
{
	updateContext();
...
void oeav_ssx::setSelection(size_t itemNum)
{
