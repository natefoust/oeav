...
BEGIN_MESSAGE_MAP(oeav_dsx, CDialogX)
	ON_WM_ERASEBKGND()
...
oeav_dsx::oeav_dsx(CWnd* pParent /*=nullptr*/)
	: CDialogX(OEAV_DSX, pParent),
	_chooseMode(false)
{
}

void oeav_dsx::DoDataExchange(CDataExchange* pDX)
{
...
void oeav_dsx::buildLayout()
{
	UpdateLayout();
}

void oeav_dsx::onAddRequested()
{
	updateContext();
...
void oeav_dsx::onDeleteRequested()
{
	updateContext();
...
void oeav_dsx::changeDisplayedItem(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void oeav_dsx::onChooseRequested()
{
	updateContext();
...
void oeav_dsx::setSelection(size_t itemNum)
{
