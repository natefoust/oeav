...
BEGIN_MESSAGE_MAP(DocumentRegistrationDlg, CDialogX)
	ON_WM_ERASEBKGND()
...
DocumentRegistrationDlg::DocumentRegistrationDlg(CWnd* pParent /*=nullptr*/)
	: CDialogX(IDD_DOC_REG, pParent),
	_chooseMode(false)
{
...
void DocumentRegistrationDlg::DoDataExchange(CDataExchange* pDX)
{
...
BOOL DocumentRegistrationDlg::OnInitDialog()
{
...
void DocumentRegistrationDlg::initControls()
{
...
void DocumentRegistrationDlg::buildLayout()
{
	UpdateLayout();
}

void DocumentRegistrationDlg::onAddRequested()
{
	updateContext();
...
void DocumentRegistrationDlg::onDeleteRequested()
{
	updateContext();
...
void DocumentRegistrationDlg::onExitRequested()
{
	updateContext();
...
void DocumentRegistrationDlg::fillTable()
{
	_documents = InstanceFactory<service::IDocumentsService>::getInstance()->getDocuments();
...
void DocumentRegistrationDlg::fillComboboxes()
{
...
void DocumentRegistrationDlg::changeDisplayedItem(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void DocumentRegistrationDlg::onChooseRequested()
{
	updateContext();
...
void DocumentRegistrationDlg::setSelection(int itemNum)
{
...
void DocumentRegistrationDlg::updateContext()
{
	if (_documents->empty())
	{
...
void DocumentRegistrationDlg::onNextRequested()
{
	updateContext();
...
void DocumentRegistrationDlg::onPrevRequested()
{
	updateContext();
...
void DocumentRegistrationDlg::onDocumentChanged()
{
	updateContext();
	setSelection(_current);
}

void DocumentRegistrationDlg::onOperationChanged()
{
	updateContext();
	setSelection(_current);
}